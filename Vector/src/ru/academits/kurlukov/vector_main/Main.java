...
public class Main {
    public static void main(String[] args) {
        ...
        double[] vector2Components = {4, 5, 6};
        ...
        double[] vector3Components = {1, 2, 3};
        Vector vector3 = new Vector(vector3Components);
        System.out.println("vector3: " + vector3);

        double[] vector4Components = {4, 5, 6};
        ...
        Vector sum = Vector.add(vector6, vector7);
        System.out.println("Результат суммы векторов vector6 и vector7: " + sum);

        Vector difference = Vector.subtract(vector6, vector7);
        System.out.println("Результат вычитания векторов vector6 и vector7: " + difference);

        double scalarProduct = Vector.scalarProduct(vector6, vector7);
